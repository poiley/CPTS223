...
namespace Quadratic {    
    ...
    class HashTable {
        public:
            ...
            bool contains( const HashedObj &x, int hash_code ) const { // Hash Code = 1: simple; 2: prefix; 3: full
                switch(hash_code) {
                    case 1:
            ...
            bool insert(const HashedObj &x, int hash_code) { // HASH CODE = 1: simple; 2: prefix; 3: full
                int currentPos;
                // Insert x as active
                switch(hash_code) {
                    case 1:
